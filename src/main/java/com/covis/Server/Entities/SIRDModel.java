...
public class SIRDModel {
    ...
    public List<CovidDailyCasesDto> resolve (BigDecimal initialS, BigDecimal initialI, BigDecimal initialR, BigDecimal initialD, LocalDate initialDate, LocalDate lastDate, CovidCasesType type){
